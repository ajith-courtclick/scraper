...
CREATE TABLE IF NOT EXISTS case_types (
    case_type_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS litigants (
    litigant_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    litigant_name VARCHAR(255)
);

-- Create advocates table
CREATE TABLE IF NOT EXISTS advocates (
    advocate_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS case_litigants (
    case_litigant_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS sections (
    ...
    created_at TIMESTAMP NULL DEFAULT NULL,
    updated_at TIMESTAMP NULL DEFAULT NULL,
    UNIQUE KEY unique_section_number (section_number)
);
...
CREATE TABLE IF NOT EXISTS case_acts (
    ...
    act_id BIGINT UNSIGNED NOT NULL,
    act_section_id BIGINT UNSIGNED DEFAULT NULL,
    created_at TIMESTAMP NULL DEFAULT NULL,
    updated_at TIMESTAMP NULL DEFAULT NULL,
    FOREIGN KEY (case_id) REFERENCES cases(case_id),
    FOREIGN KEY (act_id) REFERENCES acts(id),
...
CREATE TABLE case_ias (
    ia_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
    case_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS fir_details (
    fir_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    case_id BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS judgements (
    judgement_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    case_id BIGINT UNSIGNED NOT NULL,
